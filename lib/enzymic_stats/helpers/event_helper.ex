defmodule EnzymicStats.Helpers.EventHelper do
  ...
  def should_save_event?(event_params) do
    if Map.has_key?(event_params, "client_data") do
      ...
      amp = ua == "Amazon CloudFront"
      not_bot = !Browser.bot?(ua) and Browser.known?(ua) and !Browser.search_engine?(ua) and !Browser.phantom_js?(ua)
      not_bot or amp
    else
      false
    end
